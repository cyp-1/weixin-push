...
public class CalendarUtil {
    ...
    private final static String START_DATE1 = "1900-01-30";
    ...
    public static String lunarToSolar(String lunarDate, boolean leapMonthFlag) throws Exception{
        ...
        Date myDate = null;
        myDate = formatter.parse(START_DATE1);
...
//        return new StringBuilder().append(lunarYear).append("-").append(lunarMonth).append("-").append(lunarDay).toString();
    ...
    public static int calculateLeave(String day) throws ParseException {
